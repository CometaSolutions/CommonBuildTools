...
{
   public class CreateNuGetPackagesFileTask : Task
   {
      ...
      [Output]
      public ITaskItem[] NuGetPackagesFiles { get; set; }
      ...
      public override Boolean Execute()
      {
         ...
         if ( nuGetManagementDoc != null )
         {
            try
            {
               ...
               var packageInfos = this.ExtractPackagesFileInfos( ngm );
               this.CreatePackageConfigFiles( packageInfos );
               this.NuGetPackagesFiles = packageInfos
...
internal static partial class E_CBT
{
   ...
   internal static ITaskItem CreateTaskItem( this NuGetManagement ngm, PackagesFileInfo info )
   {
      ...
      retVal.SetMetadata( "PackagesDirectory", info.OutputDirectory );
      retVal.SetMetadata( "Source", String.Join( ";", info.Sources ) );
      retVal.SetMetadata( "ConfigFile", info.NuGetConfigPath );
      retVal.SetMetadata( "NoCache", info.NoCache ? "true" : "" );
      retVal.SetMetadata( "DisableParallelProcessing", ngm.GlobalConfiguration != null && ngm.GlobalConfiguration.DisableParallelProcessing ? "true" : "" );
